...
*/
    ...
    String queryy = "insert into TABEL1(NAME,COURSE) "+"VALUES('" + data1 + "','" + data2 + "')";
    ...
    public  void PdfGenerate(){
        try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream("H:/tilish2333.pdf"));
            document.open();
